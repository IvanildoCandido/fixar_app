...
export const LogoPreview = styled.Image`width: 160px; height: 92px; margin-bottom: ${({ theme }) => theme.spacing.md}px;`;
...
export const Help = styled.Text`margin: ${({ theme }) => theme.spacing.sm}px 0 ${({ theme }) => theme.spacing.md}px; text-align: center; font-family: ${({ theme }) => theme.fonts.regular}; font-size: ${({ theme }) => theme.typography.caption.size}px; color: ${({ theme }) => theme.colors.muted};`;
